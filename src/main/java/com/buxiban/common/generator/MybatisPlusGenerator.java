package com.buxiban.common.generator;
...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("ChenWei");//《==== 作者名
        gc.setOpen(false);
        mpg.setGlobalConfig(gc);

        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://localhost:3306/buxiban_dev?useUnicode=true&useSSL=false&characterEncoding=utf8");
